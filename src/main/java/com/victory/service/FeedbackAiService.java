...
public class FeedbackAiService {
    ...
    private static final String KOREAN_ONLY_OUTPUT_RULE = """
            ...
            - 가능하면 왜 고쳐야 하는지도 함께 설명하되 2~3문장, 최대
              4문장을 넘지 않는다.
    ...
    private static final String SYSTEM_PROMPT_PRE_READING_QUESTION = """
            ...
            message 작성 규칙 (초등학교 4학년이 이해할 수 있는 쉬운 문장, 2~3문장):
            ...
            - failedRule이 NOT_A_QUESTION이면:
              무엇이 빠져 질문으로 보이지 않는지 학생 입력을 기준으로 짚고
              고쳐쓰기 예를 줘. 예: "지금 문장은 토끼의 귀를 설명하고
              있어서 궁금한 점이 보이지 않아. '토끼는 왜 귀가 길까요?'처럼
              묻는 문장으로 바꿔 보자."
            ...
            - failedRule이 NOT_RELATED_TO_STAGE이면:
              학생 질문의 주제가 현재 자료와 어떻게 다른지 짚고, 현재
              단계에서 실제로 본 사람·물건·색깔·장소·행동 중 하나를 골라
              질문하도록 안내해.
            ...
            - failedRule이 ANSWER_NOT_RELATED이면 질문 자체는 이미 통과했다는
              ...
              다시 적어 보세요."
              가능하면 "질문은 아이가 우는 이유를 묻고 있는데 답은 토끼
              이야기라 서로 이어지지 않아. 아이가 왜 울고 있다고
              생각하는지 적어 보자."처럼 실제 두 주제를 직접 말해.
