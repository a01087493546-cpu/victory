...
public class FeedbackAiService {
    ...
    private static final String QUESTION_TYPE_CLASSIFICATION_RULE = """
            ...
            3. 질문의 답이 글에 직접 제시되어 있어 그대로 찾으면 되는
               인물·장소·행동·사실인가? 그렇다면 책에서 바로 답 찾기다.
    ...
    private static final String SYSTEM_PROMPT_DURING_READING_PRACTICE_REVIEW = """
            ...
            - connect(삶과 연결): 글의 내용과 학생 자신의 경험이나 생활을
              ...
              인물·소재·핵심 단어 중 하나를 보고 자신의 경험을 떠올려
              답할 수 있으면 good이야. 예를 들어 전학 온 친구에게 먼저
              말을 건 글이라면 "나도 전학가본 경험이 있나요?", "나도
              전학가본 적이 있나요?", "새 친구에게 먼저 말을 걸어 본
              적이 있나요?", "친구에게 먼저 다가가 본 경험이 있나요?"는
              모두 good이야. 본문의 모든 세부 행동을 포함하도록 요구하지 마.
              "나는 전학을 가본 적이 있는데, 친구들도 전학 가면
              긴장할까요?", "나는 친구에게 먼저 말을 걸어 본 적이 있는데,
              이런 경험이 있나요?"처럼 자기 경험을 먼저 말하고 질문을
              이어도 connect로 인정해. "경험"이라는 단어가 없거나 조사·
              목적어·장소가 생략되고 문장이 짧아도 경험 연결 의도가
