...
public class DemoExperienceDataInitializer implements ApplicationRunner {
    ...
    private static final Map<String, List<QA>> BEFORE_QUESTIONS = Map.of(
        ...
        "긴긴밤", List.of(
            new QA("제목 '긴긴밤'을 보고 무엇이 궁금했나요?", "밤이 왜 그렇게 길게 느껴지는지, 누구의 긴긴밤 이야기인지 궁금했어요.", "title"),
            new QA("표지 그림을 보고 무엇을 예상했나요?", "표지에 코뿔소와 펭귄이 함께 있는 그림을 보고 서로 다른 동물이 친구가 되는 이야기일 것 같다고 예상했어요.", "picture"),
            new QA("차례를 보고 궁금했던 점은 무엇인가요?", "차례에 여러 동물 이름이 나와서 노든이 여행하며 어떤 동물들을 만나게 되는지 궁금했어요.", "contents")),
        "아낌없이 주는 나무", List.of(
            new QA("제목 '아낌없이 주는 나무'를 보고 무엇이 궁금했나요?", "나무가 누구에게 무엇을 아낌없이 준다는 것인지 궁금했어요.", "title"),
            new QA("표지 그림을 보고 무엇을 예상했나요?", "표지에 나무와 소년이 함께 있는 그림을 보고 둘이 오랫동안 친구로 지내는 이야기일 것 같다고 예상했어요.", "picture"),
            new QA("책을 훑어보고 궁금했던 점은 무엇인가요?", "나무와 소년이 여러 장면에서 함께 나와서, 소년이 자라면서 둘 사이가 어떻게 달라지는지 궁금했어요.", "skim")),
        "수상한 도서관", List.of(
            new QA("제목 '수상한 도서관'을 보고 무엇이 궁금했나요?", "도서관에서 어떤 수상한 일이 벌어지는지 궁금했어요.", "title"),
            new QA("표지 그림을 보고 무엇을 예상했나요?", "표지에 어두운 책장 사이로 빛이 새어 나오는 그림을 보고 도서관에 비밀이 숨겨져 있을 것 같다고 예상했어요.", "picture"),
            new QA("차례를 보고 궁금했던 점은 무엇인가요?", "차례에 단서, 비밀 같은 말이 있어서 주인공이 어떤 단서를 찾게 되는지 궁금했어요.", "contents")),
        "우리 몸의 신비", List.of(
            new QA("제목 '우리 몸의 신비'를 보고 무엇이 궁금했나요?", "우리 몸에 어떤 신기한 점이 있는지 궁금했어요.", "title"),
            new QA("표지 그림을 보고 무엇을 예상했나요?", "표지에 몸속 기관 그림이 있어서 몸 안의 여러 기관을 설명하는 책일 것 같다고 예상했어요.", "picture"),
            new QA("차례를 보고 궁금했던 점은 무엇인가요?", "차례에 심장, 뇌, 폐 같은 말이 있어서 각 기관이 어떤 일을 하는지 궁금했어요.", "contents")),
        "강아지똥", List.of(
            new QA("제목 '강아지똥'을 보고 무엇이 궁금했나요?", "강아지똥이 이야기에서 어떤 역할을 하는지 궁금했어요.", "title"),
            new QA("표지 그림을 보고 무엇을 예상했나요?", "표지에 작은 강아지똥과 노란 민들레가 함께 있어서 둘이 어떤 관계인지 궁금했어요.", "picture"),
            new QA("책을 훑어보고 궁금했던 점은 무엇인가요?", "민들레라는 말이 자주 나와서 강아지똥과 민들레 사이에 무슨 일이 있는지 궁금했어요.", "skim")),
        "책 먹는 여우", List.of(
            new QA("제목 '책 먹는 여우'를 보고 무엇이 궁금했나요?", "여우가 진짜 책을 먹는다는 것인지 궁금했어요.", "title"),
            new QA("표지 그림을 보고 무엇을 예상했나요?", "표지에 여우가 책과 함께 있는 그림을 보고 책을 아주 좋아하는 여우 이야기일 것 같다고 예상했어요.", "picture"),
            new QA("차례를 보고 궁금했던 점은 무엇인가요?", "차례에 소금, 후추 같은 말이 있어서 여우가 책을 어떻게 먹는지 궁금했어요.", "contents")),
        "초정리 편지", List.of(
            new QA("제목 '초정리 편지'를 보고 무엇이 궁금했나요?", "초정리가 어디인지, 편지에 어떤 이야기가 담겨 있는지 궁금했어요.", "title"),
            new QA("표지 그림을 보고 무엇을 예상했나요?", "표지에 붓과 편지지가 있는 그림을 보고 옛날에 글을 배우는 이야기일 것 같다고 예상했어요.", "picture"),
            new QA("책을 훑어보고 궁금했던 점은 무엇인가요?", "편지라는 말이 자주 나와서 장운이가 누구에게 편지를 쓰는지 궁금했어요.", "skim"))
    );
    private static final Map<String, List<QA>> DURING_QUESTIONS = Map.of(
        ...
        "긴긴밤", List.of(
            new QA("노든이 혼자가 된 까닭은 무엇이었나요?", "가족과 무리를 잃고 홀로 남겨졌기 때문이에요.", "find"),
            new QA("노든이 어린 펭귄을 돌보기로 한 까닭은 무엇일까요?", "혼자 남은 펭귄이 자기처럼 외로워 보여서 지켜 주고 싶었기 때문이라고 생각해요.", "infer"),
            new QA("노든과 펭귄이 함께 걷는 장면에서 어떤 마음이 들었나요?", "둘이 서로 의지하는 모습이 따뜻하게 느껴졌어요.", "feel"),
            new QA("나라면 노든처럼 낯선 존재를 도와줄 수 있을까요?", "저도 도움이 필요해 보이는 친구가 있으면 먼저 다가가 도와주고 싶어요.", "connect")),
        "아낌없이 주는 나무", List.of(
            new QA("나무는 소년에게 무엇을 나누어 주었나요?", "사과, 가지, 줄기까지 자신이 가진 것을 계속 나누어 주었어요.", "find"),
            new QA("나무가 힘들어도 계속 나누어 준 까닭은 무엇일까요?", "소년을 진심으로 아끼고 사랑했기 때문이라고 생각해요.", "infer"),
            new QA("나무가 밑동만 남았을 때 어떤 마음이 들었을까요?", "몸은 힘들어도 소년이 쉴 수 있어서 마음은 뿌듯했을 것 같아요.", "feel"),
            new QA("나라면 나무처럼 누군가에게 아낌없이 줄 수 있을까요?", "제가 아끼는 것이라도 소중한 사람을 위해서라면 나눠 줄 수 있을 것 같아요.", "connect")),
        "수상한 도서관", List.of(
            new QA("주인공은 도서관에서 무엇을 발견했나요?", "평범해 보이던 도서관에서 이상한 단서들을 발견했어요.", "find"),
            new QA("주인공이 혼자 조사하지 않고 친구들과 함께한 까닭은 무엇일까요?", "혼자보다 함께하면 문제를 더 잘 풀 수 있다고 생각했기 때문이에요.", "infer"),
            new QA("비밀을 하나씩 풀어 갈 때 주인공은 어떤 마음이었을까요?", "무섭기도 했지만 점점 궁금증이 풀려서 신났을 것 같아요.", "feel"),
            new QA("나라면 도서관에서 수상한 것을 발견하면 어떻게 했을까요?", "저도 무서워도 친구에게 먼저 알리고 같이 알아볼 것 같아요.", "connect")),
        "우리 몸의 신비", List.of(
            new QA("이 책에서 설명하는 우리 몸의 중요한 기관은 무엇인가요?", "심장, 뇌, 폐처럼 서로 다른 일을 하는 기관들이에요.", "find"),
            new QA("여러 기관이 따로 움직이지 않고 서로 돕는 까닭은 무엇일까요?", "혼자만 일하면 몸이 제대로 움직이지 못하기 때문에 서로 도와야 한다고 생각해요.", "infer"),
            new QA("몸속 기관이 쉬지 않고 움직인다는 것을 알았을 때 어떤 마음이 들었나요?", "몸이 스스로 알아서 움직인다는 게 신기하고 고마웠어요.", "feel"),
            new QA("내 몸을 건강하게 지키기 위해 실천할 수 있는 것은 무엇인가요?", "정해진 시간에 충분히 자고 골고루 먹으려고 해요.", "connect")),
        "강아지똥", List.of(
            new QA("민들레는 강아지똥에게 무엇이 필요하다고 말했나요?", "꽃을 피우기 위해 강아지똥의 도움이 필요하다고 말했어요.", "find"),
            new QA("강아지똥이 처음에 슬퍼했던 까닭은 무엇일까요?", "자기 모습이 더럽고 아무 쓸모가 없다고 생각했기 때문이에요.", "infer"),
            new QA("강아지똥이 민들레를 도와줄 수 있다는 것을 알았을 때 어떤 마음이었을까요?", "자신도 누군가에게 필요한 존재라는 것을 알고 기뻤을 것 같아요.", "feel"),
            new QA("나도 강아지똥처럼 내가 쓸모없다고 느낀 적이 있나요?", "저도 잘하는 게 없다고 느낄 때가 있었지만, 작은 일이라도 도움이 될 수 있다는 걸 알게 됐어요.", "connect")),
        "책 먹는 여우", List.of(
            new QA("여우는 책을 읽은 뒤 무엇을 했나요?", "소금과 후추를 뿌려서 책까지 먹어 버렸어요.", "find"),
            new QA("여우가 결국 직접 이야기를 쓰기 시작한 까닭은 무엇일까요?", "더 이상 책을 구하지 못하게 되자 스스로 이야기를 만들고 싶었기 때문이라고 생각해요.", "infer"),
            new QA("여우가 자기가 쓴 책으로 다시 즐거움을 찾았을 때 어떤 마음이었을까요?", "새로운 방법을 찾아서 뿌듯하고 신났을 것 같아요.", "feel"),
            new QA("나라면 좋아하는 것을 못 하게 됐을 때 어떻게 했을까요?", "저도 다른 방법을 찾아서 계속 좋아하는 일을 하려고 노력할 것 같아요.", "connect")),
        "초정리 편지", List.of(
            new QA("장운이는 글을 배우며 무엇을 하게 되었나요?", "자신의 생각과 마음을 편지에 담아 여러 사람과 나누게 되었어요.", "find"),
            new QA("장운이가 어려워도 글을 계속 배운 까닭은 무엇일까요?", "글을 알게 되면 자기 생각을 다른 사람에게 전할 수 있다는 것을 알았기 때문이에요.", "infer"),
            new QA("장운이가 처음 편지를 쓸 수 있게 되었을 때 어떤 마음이었을까요?", "자기 생각을 전할 수 있어서 뿌듯하고 기뻤을 것 같아요.", "feel"),
            new QA("나라면 새로운 것을 배우는 게 힘들 때 어떻게 했을까요?", "저도 조금씩이라도 꾸준히 연습하면서 포기하지 않으려고 할 것 같아요.", "connect"))
    );
