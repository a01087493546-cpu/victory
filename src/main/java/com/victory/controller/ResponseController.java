...
public class ResponseController {
    ...
    @PutMapping("/book-thought/{responseId}")
    public ResponseEntity<BookThoughtResponseItem> reviseRejectedBookThoughtResponse(
            @PathVariable Long studentId,
            @PathVariable Long responseId,
            @Valid @RequestBody BookThoughtResponseRequest request,
            Authentication authentication) {
        ...
        requireSelf(studentId, authentication);
        return ResponseEntity.ok(
            responseService.reviseRejectedBookThoughtResponse(studentId, responseId, request));
    }
